...
export type RequestTaskFn<T extends any =any>=(config:AxiosRequestConfig)=>(()=>Promise<AxiosResponse<T>>)
...
export type UploadApiReturn<D extends any =any> = Promise<AxiosResponse<D>>
...
export type UploadApi<D extends any =any>=
    (chunk:UploadChunk,file?:UploadFile,onProgress?:UploadActionProgress)=>UploadApiReturn<D>
export type MergeApi=(file:UploadFile,chunks?:UploadChunk[])=>MergeApiReturn


export type CheckActionStrategy<T extends any = any>=(response:AxiosResponse<T>,file:UploadFile,chunks:UploadChunk[])=>UploadChunk[]
